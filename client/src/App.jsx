...
function SingleplayerPong() {
  ...
  const buttonStyleInline = (primary) => ({
    padding: "8px 12px",
    borderRadius: 999,
    border: "1px solid rgba(231,236,255,0.14)",
    background: primary ? "rgba(231,236,255,0.16)" : "rgba(231,236,255,0.08)",
  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 12 }}>
        <div>
          <div style={{ fontSize: 18, fontWeight: 800 }}>Modern Pong</div>
      ...
      <div style={{ marginTop: 10, opacity: 0.75, fontSize: 13 }}>
        Powerups: <b>1</b> Dash • <b>2</b> Gravity Well • <b>3</b> Decoy Ball • <b>4</b> Parry
      </div>
